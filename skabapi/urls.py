...
from skabapi.views import RegisterAPIView, Recipes, CreateRecipes, LoginAPIView, LoginView, UserProfileView, \
    UserChangePasswordView, SendPasswordResetEmailView, ResetPasswordSubmitView
